...
protocol GroupsViewModelProtocol {
    ...
    func joinGroup(withGuid: String, name: String, groupType: CometChat.groupType, password: String, indexPath: IndexPath, completion: @escaping () -> Void)
}
...
open class GroupsViewModel: NSObject, GroupsViewModelProtocol {
    ...
    internal func joinGroup(withGuid: String, name: String, groupType: CometChat.groupType, password: String, indexPath: IndexPath, completion: @escaping () -> Void) {
